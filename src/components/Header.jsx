  ...
  return (
    <div className="flex justify-between items-center px-[100px] py-4 w-full">
      <div className="flex items-center gap-6">
        ...
        <p className="text-center text-slate-900 font-normal">Records</p>
      </div>
      <div className="flex items-center gap-6">
        <button className="btn flex rounded-[20px] gap-1 items-center h-[32px] bg-[#0166FF] text-white text-base">
          <svg
